#!/usr/bin/env python3
"""
OCPP 1.6 Charger Simulator for Production Server Testing

This simulator acts like a real charging station connected to PRODUCTION:
1. Connects to OCPP production server (lyncpower.com)
...
Usage:
    python ocpp_simulator_production.py --charger-id f87a48bc-532e-4aed-862c-c6846dd278f9
    python ocpp_simulator_production.py --charger-id f87a48bc-532e-4aed-862c-c6846dd278f9 --server wss://lyncpower.com
"""
...
class OCPPChargerSimulator:
    ...
    def __init__(self, charge_point_id: str, server_url: str = "wss://lyncpower.com"):
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="OCPP 1.6 Charger Simulator - Production Server Testing",
...
Production Testing Examples:
  ...
  python ocpp_simulator_production.py --charger-id test-charger --debug

  # Auto-demo mode (starts transaction automatically after 10s)
  python ocpp_simulator_production.py --charger-id test-auto --auto-start --auto-stop 60

  # Custom intervals for production testing
  python ocpp_simulator_production.py --charger-id prod-test --heartbeat-interval 30 --meter-interval 30

  # Connect to different server
  python ocpp_simulator_production.py --charger-id test --server wss://other-server.com
        """
    )
    ...
    # Connection settings
    parser.add_argument("--server", default="wss://lyncpower.com",
                       help="OCPP server URL (default: wss://lyncpower.com)")
